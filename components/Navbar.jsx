...
const Navbar = () => {
  ...
  <div className='hidden lg:grid lg:grid-cols-16 shadow-md pt-10 items-center bg-white'>
    ...
    <div className='col-start-11 col-end-16 flex space-x-5'>
      ...
      :
      <div className='flex items-center space-x-1'><img src="/public/avtar.png" className='rounded-full w-9 h-9'/><div onClick={()=> setUserMenu(true)} className='flex text-sm items-center text-t1 cursor-pointer'><h3>Argha Paul</h3><RiArrowDropDownLine className='text-2xl'/></div></div>
      }
