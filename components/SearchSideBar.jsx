...
const SearchSideBar = () => {
  ...
  return (
    <div className='flex flex-col items-ceter py-5 w-52 mt-10 bg-white h-fit '>
     ...
     {/* Profile Tab Link */}
     <NavLink to="/search/profile"><div className={` ${title.pathname === "/search/profile" ? 'border-l-4 border-t1 bg-t1/40 [&>*]:text-t1':null} border-l-4 border-white hover:border-t1 w-full`}><div className='flex items-center space-x-2 cursor-pointer px-5 py-2 hover:bg-t1/40 hover:text-t1 w-full group'><RiUser3Fill className={`${title.pathname === "/search/profile"?'text-t1':'text-t3/40'} group-hover:text-t1 text-sm`}/><h3>Profiles</h3></div></div></NavLink>
     {/* Posts Tab Link */}
     ...
     {/* Hiring Tab Link */}
     <NavLink to="/search/hiring"><div className={` ${title.pathname === "/search/hiring" ? 'border-l-4 border-t1 bg-t1/40 [&>*]:text-t1':null} border-l-4 border-white hover:border-t1 w-full`}><div className='flex items-center space-x-2 cursor-pointer px-5 py-2 hover:bg-t1/40 hover:text-t1 w-full group'><RiUser2Fill className={`${title.pathname === "/search/hiring"?'text-t1':'text-t3/40'} group-hover:text-t1 text-sm`}/><h3>Hiring</h3></div></div></NavLink>
