...
const HomeCard = () => {
  return (
  <div className='flex flex-col ml-10 mr-10 border-2 border-t2 rounded-md mb-10'>
    ...
    <div className='flex items-center  px-10 py-5'>
     ...
     <div className='flex flex-col'>
      ...
      <div className='flex items-center space-x-5 ml-3 text-[10px] text-t2'>
        <h3>Student | Lyalpur college of Technology</h3><div class="flex items-center space-x-1"><ImPriceTag/><h3> Monika & <span>4</span> Others</h3></div>
      </div>
    </div>  
    </div>
