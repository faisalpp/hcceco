...
const HomeCard = ({post,width}) => {
  ...
  return (
  <div  className='flex flex-col ml-2 mr-2 lg:ml-10 lg:mr-10 lg:border-2 border-[1px] lg:shadow-none shadow-lg lg:border-t2/20 rounded-md mb-10'>
   ...
   <div className='lg:bg-b3/20 ml-2 lg:ml-10 lg:mr-10 lg:border-t-0 lg:border-b-0 border-t-[1px] border-b-[1px] border-t3/10 mr-2 text-xs lg:text-xs font-medium lg:rounded-sm px-5 py-3'><h3>{post.subject}</h3></div>
   ...
   {/* CARD STATES ICONS */}
   <div className='flex items-center space-x-40 ml-3 lg:ml-10 lg:border-t-2 lg:border-b-2 border-t-[1px] border-b-[1px] border-t2/20 lg:mb-10 mb-3 mr-3 lg:mr-10 py-3'>
   ...
   <div className={` ${replay ?'flex':'hidden'} flex-col h-52 lg:scrollbar-thin lg:scrollbar-thumb-t1 overflow-scroll overflow-x-hidden mb-5 w-11/12 bg-b4/30`}>
    <HomeCardReplay/>
    <HomeCardReplay/>
    <HomeCardReplay/>
    <HomeCardReplay/>
   ...
   <div className='flex lg:hidden mb-2 text-xs w-fit text-t3/70 ml-5'>{replay ? <span onClick={()=>setReplay(false)} className='hover:underline cursor-pointer'>View All Opinions &#40;155&#41;</span>:<span onClick={()=>setReplay(true)} className='hover:underline cursor-pointer'>View All Opinions &#40;155&#41;</span>}</div>
