...
const CommentBox = () => {
  ...
  return (
    <div className='flex lg:flex-row shadow-xl flex-col items-center lg:border-2 lg:border-t3/20 rounded-md px-3 lg:px-10 py-3'>
      ...
      <input value={msg} onChange={(e)=>setMsg(e.target.value)} type="text" placeholder="What's in your mind, Argha?" className='text-xs border-none w-full h-5 outline-none focus:ring-0 text-t2 px-2'/>     
      </form>
