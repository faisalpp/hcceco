    ...
    <>
     ...
     <div className='lg:grid lg:grid-cols-12 flex flex-col w-full h-auto'>
      ...
      <div className='col-start-4 col-end-13 bg-white w-full h-full'>
       <div className='lg:flex hidden justify-center w-full mt-10 text-3xl text-t1'><h3>Question</h3></div>
       <SearchNavigation/>
       <h3 className='lg:hidden mt-5 px-5 text-xl text-t1 underline'>Questions</h3>
