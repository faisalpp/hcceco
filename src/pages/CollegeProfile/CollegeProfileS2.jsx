   ...
   <form className='flex flex-col space-y-10 mb-20 w-full h-full mt-20 items-center'>
    ...
    <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
     <div className='lg:w-1/2'>
      ...
      <Select label='Colleges' value={affiliation} onChange={e=>setAffiliation(e.target.value)} name="affiliation" type="text" className=' border-2 border-t3/30 w-full lg:h-14 rounded-md px-5'>
      <Option>Colleges</Option>
      </Select>
     </div>
     <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College Name</h3><input placeholder='Enter College Name' value={clgName} onChange={e=>setClgName(e.target.value)} name="clgName" type="text" className='lg:h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
    </div>  
    {/* Form Input Group */}
    <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
     <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College Mail Id</h3><input placeholder='Enter Mail Id' value={clgMail} onChange={e=>setClgMail(e.target.value)} name="clgMail" type="text" className='form-input border-2 border-t3/30 w-full lg:h-14 rounded-md px-5'/></div>
     <div className='lg:w-1/2'>
      <h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College Type</h3>
      <Select value={clgType} onChange={e=>setClgType(e.target.value)} name="affiliation" type="text" className=' w-full lg:h-14 rounded-md px-5'>
      <Option>Colleges</Option>
      </Select>
     </div>
    </div>  
    ...
    <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
     ...
     <div className='lg:w-1/2'>
      <h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College City</h3>
      <Select value={clgAgency} onChange={e=>setClgAgency(e.target.value)} name="affiliation" type="text" className=' w-full h-12 rounded-md px-5'>
      <Option>Colleges</Option>
      </Select>
     </div>
     <div className='flex items-center justify-center mt-10 h-12 w-12 bg-t1/40'>For</div>
     <div className='lg:w-1/2'>
      <h3 className='hidden lg:flex text-white ml-5 font-semibold mb-2'>College City</h3>
      <Select value={clgCity} onChange={e=>setClgCity(e.target.value)} name="affiliation" type="text" className=' w-full h-12 rounded-md px-5'>
      <Option>Colleges</Option>
      </Select>
     </div>
     </div>
     ...
     <div className='lg:w-1/2'>
      <h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College City</h3>
      <Select   name="affiliation" type="text" className=' w-full h-12 rounded-md px-5'>
      <Option>Colleges</Option>
      </Select>
     </div>
     <div className='flex items-center justify-center mt-10 h-12 w-14 bg-t1/40'>For</div>
     <div className='lg:w-1/2'>
      <h3 className='hidden lg:flex text-white ml-5 font-semibold mb-2'>College City</h3>
      <Select value={clgCity} onChange={e=>setClgCity(e.target.value)} name="affiliation" type="text" className=' w-full h-12 rounded-md px-5'>
      <Option>Colleges</Option>
    ...
    <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
     <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College NAAC Grade</h3><input placeholder='Enter College NAAC' value={clgName} onChange={e=>setClgName(e.target.value)} name="clgName" type="text" className='lg:h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
     <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>College Status</h3><input placeholder='Enter College Status' value={clgName} onChange={e=>setClgName(e.target.value)} name="clgName" type="text" className='lg:h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
    </div>  
    <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
