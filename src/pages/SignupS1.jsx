  ...
  return (
    ...
    <div className='flex flex-col bg-white w-full h-auto items-center py-20'>
      ...
      <div className='flex mt-5 space-x-32'>
       <div className={`border-b-[7px] ${ title.pathname === "/signup/step1" ?'border-t1':'border-white'} py-5 px-28`}><h3 className='text-2xl'>Step 1</h3></div><div className={`border-b-[7px] ${title.pathname === "/signup/step2" ?'border-t1':'border-white'} py-5 px-28`}><h3 className='text-2xl'>Step 2</h3></div>
      </div>
      ...
      <form className='flex flex-col w-2/3 space-y-10 mt-10 h-auto justify-center '>
       <div className='flex lg:flex-row flex-col w-full lg:space-x-10'>
        <div className=' lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Select User Type</h3><Select name="userType" value={userType} onChange={handleUserType} placeholder='Student' className='h-14 w-full rounded-md'><Option>Student</Option></Select></div>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Name</h3><input name="name" value={name} onChange={e=>setName(e.target.value)} placeholder="Enter Full Name" type="text" className='h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
       </div>
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Designation</h3><input name="name" value={designation} onChange={e=>setDesignation(e.target.value)} type="text" placeholder='Designation' className='form-input lg:h-14 w-full rounded-md border-2 border-t3/30 px-5' /></div>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Email</h3><input name="Email" type="text" placeholder='Enter your Email' value={email} onChange={e=>setEmail(e.target.value)} className='lg:h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
       </div>
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Mobile Number</h3><input name="name" type="text" value={mobileNo} onChange={e=>setMobileNo(e.target.value)} placeholder='Enter Mobile Number' className='form-input lg:h-14 w-full rounded-md border-2 border-t3/30 px-5' /></div>
       ...
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>School/College/Company</h3><input name="type" value={type} onChange={e=>setType(e.target.value)} type="text" placeholder='School/College/Company' className='form-input lg:h-14 w-full rounded-md border-2 border-t3/30 px-5' /></div>
        <div className='lg:w-1/2'><h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Highest Education</h3><input name="education" value={education} onChange={e=>setEducation(e.target.value)} type="text" className='lg:h-14 w-full rounded-md border-2 border-t3/30 px-5'/></div>
       </div>
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='flex flex-col w-full'>
         <h3 className='hidden lg:flex text-t1 ml-5 font-semibold mb-2'>Summary</h3>
         <textarea name="summary" value={summary} onChange={e=>setSummary(e.target.value)} className='form-textarea h-32 w-full rounded-md border-2 border-t3/30 px-5'></textarea>
        </div> 
       </div>
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='lg:w-1/2'><h3 className='text-t1 ml-5 font-semibold mb-2'>Area of Experties</h3><textarea name="experties" value={experties} onChange={e=>setExperties(e.target.value)} type="text" placeholder='Experties area in comma separated value' className='form-textarea h-32 w-full rounded-md border-2 border-t3/30 px-5'></textarea></div>
       ...
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
        <div className='lg:w-1/2'><h3 className='text-t1 ml-5 font-semibold mb-2'>Total Experience</h3><input name="experience" type="text" value={experience} onChange={e=>setExperience(e.target.value)} placeholder='Enter Your Total Experience' className='form-text h-12 w-full rounded-md border-2 border-t3/30 px-5'/></div>
       </div>
       <div className='flex lg:flex-row space-y-10 lg:space-y-0 flex-col w-full lg:space-x-10 items-center'>
